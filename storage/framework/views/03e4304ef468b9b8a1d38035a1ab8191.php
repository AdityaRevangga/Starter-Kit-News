            ...
            <div class="bg-white shadow-xl rounded-lg p-8">
                <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-6">
                    ...
                    <div class="relative">
                        ...
                        <input id="name" name="name" type="text" required autofocus autocomplete="name" placeholder="Nama Lengkap" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="<?php echo e(old('name')); ?>">
...
<?php endif; ?>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" name="email" type="email" required autocomplete="username" placeholder="Email" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="<?php echo e(old('email')); ?>">
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                ...
                <div class="mt-6 text-center">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-indigo-600 hover:text-indigo-900 font-semibold">Masuk</a>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\starter-laravel-news\resources\views/auth/register.blade.php ENDPATH**/ ?>